...
cmake -B %{_builddir}/ollama-%{version} -DPATH=$PATH:/usr/local/cuda/bin -DCUDACXX=/usr/local/cuda/bin/nvcc -DGIN_MODE=release -DGGML_CCACHE=OFF -DCUDA_TOOLKIT_ROOT_DIR=/usr/local/cuda
